        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-8 lg:gap-y-12 gap-x-4 mb-16 text-center sm:text-left">
          ...
          <div className="col-span-2 lg:col-span-1 flex flex-col items-center sm:items-start mb-4 lg:mb-0">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-slate-800 p-2.5 rounded-xl hover:bg-red-700 transition-all hover:-translate-y-1 shadow-lg">
                <Facebook size={18} />
              </a>
              <a href="#" className="bg-slate-800 p-2.5 rounded-xl hover:bg-red-700 transition-all hover:-translate-y-1 shadow-lg">
                <Instagram size={18} />
          ...
          <div className="col-span-2 sm:col-span-1 border-b border-slate-800/50 sm:border-none py-4 sm:py-0">
            ...
            >
              ...
              <div className="sm:hidden">
                {openSections.links ? <ChevronUp size={16} className="text-red-600" /> : <ChevronDown size={16} className="text-gray-500" />}
              </div>
            </button>
            <ul className={`space-y-3 text-[12px] text-gray-400 font-medium mt-6 transition-all duration-300 overflow-hidden ${openSections.links ? 'max-h-60 opacity-100' : 'max-h-0 sm:max-h-none opacity-0 sm:opacity-100'}`}>
              <li><Link to="/" className="hover:text-red-500 transition-colors inline-block py-1">{t('nav.home', 'Accueil')}</Link></li>
              <li><Link to="/catalogue" className="hover:text-red-500 transition-colors inline-block py-1">{t('nav.catalogue', 'Catalogue')}</Link></li>
              <li><Link to="/a-propos" className="hover:text-red-500 transition-colors inline-block py-1">{t('nav.about', 'À propos')}</Link></li>
              <li><Link to="/contact" className="hover:text-red-500 transition-colors inline-block py-1">{t('nav.contact', 'Contact')}</Link></li>
              <li><Link to="/suivi-livraison" className="hover:text-red-500 transition-colors inline-block py-1">Suivi</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-2 sm:col-span-1 border-b border-slate-800/50 sm:border-none py-4 sm:py-0">
            ...
            >
              ...
              <div className="sm:hidden">
                {openSections.brands ? <ChevronUp size={16} className="text-red-600" /> : <ChevronDown size={16} className="text-gray-500" />}
              </div>
            </button>
            <ul className={`space-y-3 text-[12px] text-gray-400 font-medium mt-6 transition-all duration-300 overflow-hidden ${openSections.brands ? 'max-h-60 opacity-100' : 'max-h-0 sm:max-h-none opacity-0 sm:opacity-100'}`}>
              <li><Link to="/catalogue?brand=Mercedes-Benz" className="hover:text-red-500 transition-colors inline-block py-1">Mercedes</Link></li>
              <li><Link to="/catalogue?brand=BMW" className="hover:text-red-500 transition-colors inline-block py-1">BMW</Link></li>
              <li><Link to="/catalogue?brand=Audi" className="hover:text-red-500 transition-colors inline-block py-1">Audi</Link></li>
              <li><Link to="/catalogue?brand=Porsche" className="hover:text-red-500 transition-colors inline-block py-1">Porsche</Link></li>
              <li><Link to="/catalogue?brand=Volkswagen" className="hover:text-red-500 transition-colors inline-block py-1">VW</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-2 lg:col-span-1 flex flex-col items-center sm:items-start pt-8 lg:pt-0">
            ...
            <ul className="space-y-4 text-[12px] text-gray-400 font-medium">
              <li className="flex items-start justify-center sm:justify-start">
                <MapPin size={16} className="mr-3 text-red-600 flex-shrink-0 mt-0.5" />
              ...
              <li className="flex items-center justify-center sm:justify-start">
                <Mail size={16} className="mr-3 text-red-600 flex-shrink-0" />
