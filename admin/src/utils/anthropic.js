export const extractVehicleData = async (rawText) => {
    const apiKey = import.meta.env.VITE_ANTHROPIC_API_KEY;
    const endpoint = "https://api.anthropic.com/v1/messages";

    const prompt = `
    Analyze the following vehicle description and extract the data in a strict JSON format.
    ...
    - description (A short professional summary in FRENCH)
  ...
  `;
    ...
    try {
        ...
        // Claude often returns JSON inside markers or just as text
